...
class MigrationRunnerTest {
    ...
    void shouldRunMigrationsInOrder() throws Exception {
        ...
        try {
            ...
            List<TestItem> items = db
                .sql("SELECT id, label FROM test_items ORDER BY id")
                .list(TestItem.class);
