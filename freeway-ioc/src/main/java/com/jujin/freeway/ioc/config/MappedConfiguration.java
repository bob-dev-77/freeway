...
public interface MappedConfiguration<K, V> {
    ...
    /**
     * Adds a keyed object as an instantiated instance (with dependencies injected)
     * of a class. When the value type is an interface and the class to be
     * contributed is a local file, then a reloadable proxy for the value class will
     * be created and contributed.
     *
     * @param key
     *            unique id for the value
     * @param clazz
    ...
    /**
     * Overrides an existing contribution with a new instance. When the value type
     * is an interface and the class to be contributed is a local file, then a
     * reloadable proxy for the value class will be created and contributed.
     *
     * @param key
     *            unique id of value to override
     * @param clazz
