...
import com.jujin.freeway.ioc.internal.InternalRegistry;
import com.jujin.freeway.ioc.internal.JdkProxyFactory;
import com.jujin.freeway.ioc.internal.Module;
import com.jujin.freeway.ioc.internal.ServiceLocatorImpl;
    ...
    implements ServiceBuilderContext
{
    ...
    public <T> T autobuild(String description, final Class<T> clazz) {
        ...
        return registry.invoke(description, () -> {
            Constructor constructor = ReflectionUtils.findAutobuildConstructor(
                clazz
            );
