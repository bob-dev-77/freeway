 ...
 * return type, parameter types and exception types. Actual Method objects are
 * tied to a particular class, and don't compare well with other otherwise
 * identical Methods from other classes or interface; MethodSignatures are
 * distinct from classes and compare well.
 * <p>
 * Because the intended purpose is to compare methods from interfaces (which are
 * always public and abstract) we don't bother to actually track the modifiers.
 * In addition, at this time, MethodSignature <em>does not distinguish between
...
public class MethodSignature {
    ...
    /**
     * Returns the exceptions for this method. Caution: do not modify the returned
     * array. May return null.
     */
    ...
    /**
     * Returns the parameter types for this method. May return null. Caution: do not
     ...
     * <em>identical</em> values for return type, name, parameter types and
     * exception types.
     *
    ...
    public String toString() {
        ...
        buffer.append(toTypeName(returnType));
        buffer.append(' ');
        buffer.append(name);
        buffer.append('(');
     ...
     * types. This is similar to {@link #toString()}, but omits the return type and
     * information about thrown exceptions. A unique id is used by
     * {@link com.jujin.freeway.ioc.internal.MethodIterator} to identify overlapping
     * methods (methods with the same name and parameter types but with different
     * thrown exceptions).
     *
     * @see #isOverridingSignatureOf(MethodSignature)
     */
     ...
     * types as the method signature passed in, and this signature's exceptions
     * "trump" (are the same as, or super-implementations of, all exceptions thrown
    ...
    /**
     * The nuts and bolts of checking that another method signature's exceptions are
     * a subset of this signature's.
     */
