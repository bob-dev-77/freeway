...
public final class IocConstants {
    ...
    /** Service ID for the injection resolver. */
    public static final String RESOLVER_SERVICE_ID = "InjectionResolver";
