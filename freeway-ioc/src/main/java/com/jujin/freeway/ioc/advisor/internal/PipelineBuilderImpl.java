...
import com.jujin.freeway.ioc.internal.BridgeBuilder;
...
public class PipelineBuilderImpl implements PipelineBuilder {
    ...
    public <S, F> S build(
        ...
        S terminator = defaultImplementationBuilder.createDefaultImplementation(
            serviceInterface
        );
    ...
    public <S, F> S build(
        ...
        BridgeBuilder<S, F> bb = new BridgeBuilder<S, F>(
            logger,
            serviceInterface,
            filterInterface,
            proxyFactory
