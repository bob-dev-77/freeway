...
/**
 * Static methods related to the use of JDK 1.5 generics. From Freeway 5.5.0,
...
public class GenericsUtils {
     ...
     */
    public static Class<?> extractGenericReturnType(
        Class<?> containingClass,
        Method method) {
        return GENERICS_RESOLVER.extractGenericReturnType(
            containingClass,
            method);
    }
    ...
    public static Class<?> extractGenericFieldType(
        Class<?> containingClass,
        Field field) {
        return GENERICS_RESOLVER.extractGenericFieldType(
            containingClass,
            field);
    }
